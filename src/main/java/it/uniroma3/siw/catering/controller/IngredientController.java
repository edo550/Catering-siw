...
import it.uniroma3.siw.catering.validator.IngredientValidator;
...
public class IngredientController {
	...
	public String editBuffet(@PathVariable Long id, @Valid @ModelAttribute("ingredient") Ingredient ingredient,
